 ...
 *
 * Stateless — no DB or user context needed. The factory pattern is used for
 * consistency with all other tools in the barrel export.
 */
export function createAnalyzeFormTool() {
	return tool(
