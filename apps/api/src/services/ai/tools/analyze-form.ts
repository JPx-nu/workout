...
export const analyzeForm = tool(
    ...
    },
    {
        ...
        schema: z.object({
            ...
            specificFocus: z
                .string()
                .describe("What the user specifically wants critiqued (e.g., 'catch phase in swim', 'squat depth', 'running cadence')."),
            userNotes: z
                .string()
                .optional()
                .describe("Any context the user provided about their injury history or current feelings during this workout."),
        }),
    }
);
