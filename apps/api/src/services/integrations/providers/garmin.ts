...
export class GarminProvider implements IntegrationProvider {
    ...
    buildAuthUrl(state: string): string {
        ...
        console.warn("[Garmin] OAuth 1.0a not yet implemented — requires business API approval");
    ...
    async exchangeCode(code: string): Promise<OAuthTokens> {
        ...
        throw new ProviderUnavailableError("GARMIN", "OAuth 1.0a token exchange not yet implemented — awaiting API approval");
    }
    ...
    async revokeAccess(_accessToken: string): Promise<void> {
        ...
        console.warn("[Garmin] Access revocation not yet implemented");
    }
    ...
    verifyWebhook(
        ...
        // TODO: Verify Garmin webhook signature when API access is granted
        return true;
    }
    ...
    async fetchHealthData(
        ...
        try {
            ...
            console.error("[Garmin] fetchHealthData error:", err);
        }
