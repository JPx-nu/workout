...
import { Activity, Brain, Waves, Bike, Footprints, Shield, Zap, Users } from 'lucide-react';

const features = [
  {
    icon: Brain,
    title: 'AI Coach',
    description: 'GraphRAG-powered coaching that understands your training history, injuries, and goals.',
  ...
  },
  {
    ...
    description: 'Team gamification with baton passes, squad challenges, and real-time leaderboards.',
    color: 'var(--color-swim)',
  },
  {
    icon: Shield,
    title: 'Club-Grade Security',
    description: 'Multi-tenant isolation with Custom Claims JWT and row-level security on every table.',
...
export default function LandingPage() {
  return (
    <div className="min-h-screen">
      ...
      <header className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 animate-fade-in">
          ...
          <p className="max-w-2xl mx-auto text-lg sm:text-xl mb-10 leading-relaxed"
            ...
            Intelligent training plans, real-time health insights, and team gamification —
            all powered by agentic AI that learns your body and your goals.
          </p>

          <div className="flex items-center justify-center gap-4">
            <Link href="/dashboard" className="btn-primary text-base px-8 py-3 inline-flex items-center gap-2">
              <Zap size={18} />
              Enter Dashboard
            </Link>
            <Link href="/dashboard/coach" className="btn-ghost text-base px-6 py-3 inline-flex items-center gap-2">
              <Brain size={18} />
              Try AI Coach
            </Link>
          </div>
        ...
        <div className="absolute bottom-8 animate-bounce opacity-40">
          <div className="w-6 h-10 rounded-full border-2 flex items-start justify-center p-1"
            ...
            <div className="w-1.5 h-3 rounded-full" style={{ background: 'var(--color-text-muted)' }} />
          </div>
        </div>
      </header>
      ...
      {/* Footer */}
      <footer className="max-w-6xl mx-auto px-6 py-8 flex items-center justify-between text-sm"
