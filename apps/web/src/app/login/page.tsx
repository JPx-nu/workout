        ...
        <div className="flex min-h-screen items-center justify-center p-4"
            ...
            <div className="glass-card w-full max-w-sm p-8 space-y-6">
                ...
                <div className="text-center space-y-2">
                    <div className="inline-flex w-12 h-12 rounded-xl items-center justify-center text-base font-bold mx-auto"
                ...
                {!signUpSuccess && (
                    <>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xs" style={{ color: 'var(--color-text-muted)' }}>or sign in</span>
                            <div className="flex-1 h-px" style={{ background: 'var(--color-glass-border)' }} />
                        </div>
