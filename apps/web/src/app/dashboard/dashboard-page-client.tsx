...
import type { MappedWorkout } from "@triathlon/core";
...
export default function DashboardPage({ initialWorkouts }: { initialWorkouts: MappedWorkout[] }) {
	const { profile } = useProfile();
	const { weeklyStats, chartData, allWorkouts, strengthMetrics } = useWorkouts(initialWorkouts);
