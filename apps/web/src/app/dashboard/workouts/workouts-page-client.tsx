...
import { formatDuration, formatPace, type MappedWorkout, mToKm } from "@triathlon/core";
import { Filter } from "lucide-react";
import Link from "next/link";
import { useWorkouts } from "@/hooks/use-workouts";
import { getActivityConfig } from "@/lib/activity-config";

export default function WorkoutsPage({ initialWorkouts }: { initialWorkouts: MappedWorkout[] }) {
	const { workouts, allWorkouts, filter, setFilter } = useWorkouts(initialWorkouts);
