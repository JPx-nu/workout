...
var _$jscomp$lookupPolyfilledValue = (k, n) => {
...
var DracoDecoderModule = (() => {
	...
	return (n) => {
		...
		var Xa = Object.assign({}, a),
			...
			U = "";
		if (Ya) {
			var Za = require("node:fs"),
				qa = require("node:path");
		...
		(() => {
			...
			(() => fa ||
					...
					? c(b)
					: fetch(P, { credentials: "same-origin" }).then((g) => WebAssembly.instantiateStreaming(g, d).then(b, (u) => {
